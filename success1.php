...
<div class="container">
    ...
    <div id="bar_7" class="eight columns">
        ...
        <div id="inside_bar3">
            <div>
            <h3>Thank you for getting in touch, a member of staff will work on getting back to you as soon as possible.</h3>
          </div>
            <div id="dialog" title="Thank You!">
            <p>Thank you for getting in touch, a member of staff will work on getting back to you as soon as possible. </p>
          </div>
          </div>
      </div>
      </div>
        ...
        <div id="inside_bar">
            ...
            <div id="honours-main-body">
                ...
                <div id="honours-index-list-container">
                    ...
                    <li class="honours-index-li"><a href="test.php">
