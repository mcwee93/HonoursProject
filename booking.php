...
?>
            ...
            <div id="r">
                ...
                <table >
                    ...
                    <td width="216"><input name="booking1"  id="bookingdate1" type="date" min="<?php echo date('Y-m-d'); ?>" required  value="<?php if(isset($_POST['bookingdate1'])){ echo $_POST['bookingdate1']; }?>"  onchange="getdate()" /></td>
                    ...
                    <input name="user" type="hidden" value=" <?php $user->get_email($id);?> " />
                      ...
                      <tr>
                    <td>Facility Type </td>
                    <td><select class="text_select" id="booking_price" name="booking_price">
                        <?php
	  ...
	  ?>
                    ...
                    <td>&#163; <span id="a1" ></span></td>
                      ...
                      <tr>
                    <td>No. of Players</td>
                    <td><input name="guest" type="text " size="10" required/></td>
                  </tr>
                      <tr>
                    <td>No. of Bookings </td>
                    <td><input name="booking_nos" id="booking_nos" type="text " size="10" onChange="gettotal1()" required/></td>
                  </tr>
                      <tr>
                    <td>Amount due on Arrival</td>
                    <td><input type="text" name="pricetopay" id="total1"  size="10px" readonly /></td>
                    <td><input type="hidden" name="bookingdate3" id="bookingdate3"  size="10px" readonly /></td>
                  </tr>
                      <tr>
                    <td colspan="2" align="center"><input type="submit" name="sub" value="Book" /></td>
                  </tr>
                    </table>
              </form>
                  <script language="javascript" type="text/javascript">
...
notEmpty()
   ...
   function gettotal1(){
      var bookingvalue1=document.getElementById('a1').innerHTML;
      var bookingvalue2=document.getElementById('booking_nos').value;
      var bookingvalue3=parseFloat(bookingvalue1)* parseFloat(bookingvalue2);
			
      document.getElementById('total1').value=bookingvalue3;
